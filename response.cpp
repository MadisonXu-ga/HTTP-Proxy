...
void Response:: parseLastModify()
{
    if(response_content.find("Last-Modified: ") != string :: npos)
    {
        ...
        LastModify_begin += 15;
        last_modify = response_content.substr(LastModify_begin, LastModify_end - LastModify_begin);
    }
}
...
void Response:: parseContent_len()
{
    if(response_content.find("Content-Length: ") != string :: npos)
    {
        ...
        Contentlen_begin += 16;
        last_modify = response_content.substr(Contentlen_begin, Contentlen_end - Contentlen_begin);
    }
}
...
string Response:: getContent() {return response_content;}
string Response:: getStatus() {return status;}
string Response:: getDate() {return date;}
string Response:: getExpires() {return expire;}
string Response:: getEtag() {return etag;}
string Response:: getLastModify() {return last_modify;}
string Response:: getCode() {return code;}
size_t Response:: getMaxage() {return max_age;}
size_t Response:: getMaxstale() {return max_stale;}
size_t Response:: getContentlen() {return content_length;}